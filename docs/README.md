...
This folder contains implementation-level documentation for maintaining the Stash Native SDK across Android and iOS. Paths in the docs use links relative to the repository root so you can open the corresponding source files from the clone.
