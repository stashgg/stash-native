...
public final class SettingsItem {
  ...
  private SettingsItem(int type, int titleRes, int supportingRes, String value,
      boolean checked, int progress, boolean expanded,
  ...
  public static SettingsItem sectionHeader(
    ...
    return new SettingsItem(
        TYPE_SECTION_HEADER, titleRes, 0, null, false, 0, false, firstInCard, lastInCard);
  }
  ...
  public static SettingsItem sectionFooter(
      @StringRes int titleRes, boolean firstInCard, boolean lastInCard) {
    return new SettingsItem(
        TYPE_SECTION_FOOTER, titleRes, 0, null, false, 0, false, firstInCard, lastInCard);
  }
  ...
  public static SettingsItem urlPreference(
    ...
    return new SettingsItem(
        TYPE_URL_PREFERENCE, titleRes, 0, value, false, 0, false, firstInCard, lastInCard);
  }
  ...
  public static SettingsItem actionPreference(
      @StringRes int titleRes, boolean firstInCard, boolean lastInCard) {
    return new SettingsItem(
        TYPE_ACTION_PREFERENCE, titleRes, 0, null, false, 0, false, firstInCard, lastInCard);
  }

  /** Expandable section header. */
  public static SettingsItem expandableHeader(
      @StringRes int titleRes, boolean expanded, boolean firstInCard, boolean lastInCard) {
    return new SettingsItem(
        TYPE_EXPANDABLE_HEADER, titleRes, 0, null, false, 0, expanded, firstInCard, lastInCard);
  }
  ...
  public static SettingsItem switchPreference(
      ...
      boolean firstInCard, boolean lastInCard) {
    return new SettingsItem(
        TYPE_SWITCH_PREFERENCE, titleRes, supportingRes, null, checked, 0, false,
  ...
  public static SettingsItem sliderPreference(
    ...
    int pct = progress + 10;
    return new SettingsItem(
        TYPE_SLIDER_PREFERENCE, titleRes, 0, pct + "%", false, progress, false,
        firstInCard, lastInCard);
  }
}
