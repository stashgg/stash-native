...
// %LOCALAPPDATA%\Stash\<executable name, lower-cased>-<hash of the executable path>\WebView2: one
// WebView2 profile per installed game, so same-named executables of different titles never share one.
