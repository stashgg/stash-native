 ...
 * {@link StashNativeCardPlugin}'s {@code StashJavaScriptInterface} (modal and popup dialogs) and
 * {@link StashNativeCardPortraitActivity}'s {@code JSInterface} (the portrait card).
 *
